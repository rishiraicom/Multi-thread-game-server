...
2.)execute the server using the command: java MultiThreadGameServer
3.)to make a new client open a new terminal and type command: java MultiThreadGameClient
...
5.accept [name of the person who made a request to you]:to accept request.
